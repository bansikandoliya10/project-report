        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <div class="d-flex mx-auto flex-column flex-lg-row align-items-center">
            <ul class="navbar-nav  ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="furniture.php">locker</a>
              </li>
              <li class="nav-item">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p>
              Banks to agrrange for the stamp paper for the revised locker agreement.
              agreement cost to be borne by banks, not customer.
            </p>
            <a href="">
              Read More
            </a>
