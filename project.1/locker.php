  ...
  <section class="furniture_section layout_padding">
    <div class="container">
      <div class="heading_container">
        ...
        <p>
         <h6 style=""> security for your valuables avail safe deposit locker facility of apna bank of india </h6>
        </p>
      </div>
      <div class="row">
        <div class="col-md-7 col-lg-5">
          <div class="box">
            <div class="img-box">
              <img src="images/locker.png" alt="" style="min-height:200px; max-height:200px">
            </div>
            <div class="detail-box">
              <h5>
                small size of locker
              </h5>
              <div class="price_box">
        ...
        <div class="col-md-7 col-lg-5">
          <div class="box">
            <div class="img-box">
              <img src="images/locker4.png" alt="" style="min-height:200px; max-height:200px">
            </div>
            <div class="detail-box">
              <h5>
                medium size of locker
              </h5>
              <div class="price_box">
                <h6 class="price_heading">
                  <span>Rs</span> 3000/-
        ...
        <div class="col-md-7 col-lg-5">
          <div class="box">
            <div class="img-box">
              <img src="images/lok.jpg" alt="" style="min-height:200px; max-height:200px">
            </div>
            <div class="detail-box">
              <h5>
                large size of locker
              </h5>
              <div class="price_box">
                <h6 class="price_heading">
                  <span>Rs</span> 6000/-
        ...
        <div class="col-md-7 col-lg-5">
          <div class="box">
            <div class="img-box">
              <img src="images/def.png" alt="" style="min-height:200px; max-height:200px">
            </div>
            <div class="detail-box">
              <h5>
                Extra large size of locker
              </h5>
              <div class="price_box">
                <h6 class="price_heading">
                  <span>Rs</span> 9000/-
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="info_links">
              ...
              <div class="info_links_menu">
                ...
                <a class="" href="furniture.php">locker</a>
